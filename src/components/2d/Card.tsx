...
const Card: FC<CardType> = (props: CardType) => {
  ...
  return (
    <div className={`flex flex-col ${team === 2 ? 'ml-auto' : 'mr-auto'} bg-gradient-to-b from-cyan-400 to-green-400 shadow-xl shadow-green-400/50 rounded-xl ring-2 ring-cyan-400/50 sm:w-1/4 w-1/3 h-24 px-4 py-3 space-y-0.5 text-white font-bold drop-shadow`}>
